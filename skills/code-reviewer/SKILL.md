...
Scénarios dans `evals/eval.json`. Ils portent les cas où le skill doit ne rien trouver — un reviewer qui trouve toujours un bloquant est indiscernable d'un reviewer qui fonctionne.
