...
- Un contexte de session qui se recharge automatiquement en début de tâche vaut mieux qu'un rappel manuel
...
- Sauvegarde de contexte avant interruption
- Rechargement de contexte à la reprise
